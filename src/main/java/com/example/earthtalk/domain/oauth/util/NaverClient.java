...
public class NaverClient implements OAuthClient {
    ...
    @Autowired
    public NaverClient(RestTemplateBuilder builder) {
    ...
    public Map<String, Object> getProfileFromAccessToken(ClientRegistration clientRegistration, String accessToken) {
        ...
        Map<String, Object> response = requestNaverResourceServer(clientRegistration, httpEntity);
        System.out.println(response);
    ...
    private NaverAccessTokenResponse requestNaverOauthAPIServer(
    ...
    private Map requestNaverResourceServer(ClientRegistration clientRegistration, HttpEntity<Void> httpEntity) {
        return restTemplate.exchange(
