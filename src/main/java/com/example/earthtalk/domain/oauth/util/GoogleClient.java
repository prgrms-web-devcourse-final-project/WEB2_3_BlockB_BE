...
import com.example.earthtalk.domain.oauth.dto.response.accessToken.GoogleAccessTokenResponse;
...
public class GoogleClient implements OAuthClient {
    ...
    public GetToken getAccessTokenFromAuthCode(ClientRegistration clientRegistration, String authCode) {
        ...
        GoogleAccessTokenResponse response = Optional.ofNullable(requestGoogleOauthAPIServer(clientRegistration, httpEntity))
    ...
    public Map<String, Object> getProfileFromAccessToken(ClientRegistration clientRegistration, String accessToken) {
        ...
        Map<String, Object> response = requestGoogleResourceServer(clientRegistration, httpEntity);
    ...
    private Map requestGoogleResourceServer(ClientRegistration clientRegistration, HttpEntity<Void> httpEntity) {
        return restTemplate.exchange(
