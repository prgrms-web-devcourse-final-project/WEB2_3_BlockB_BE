 ...
 * 해당 정보를 포함하는 {@link DebateRoom} 객체를 생성하여 별도의 저장소({@link DebateRoomStore})에 보관합니다.
...
public class DebateRoomService {
	 ...
	 * 해당 정보를 포함하는 {@link DebateRoom} 객체를 생성하여 저장소에 보관합니다.
	 * </p>
	 *
	...
	public String createDebateRoom(CreateDebateRoomRequest request) {
		...
		debateRoomStore.put(debateRoom);
		return roomId;
	}
	 ...
	 * @return 해당 채팅방 정보를 담은 {@link DebateRoom} 객체, 존재하지 않으면 null
	 */
	public DebateRoom getDebateRoom(String roomId) {
